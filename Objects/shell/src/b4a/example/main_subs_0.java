...
xhttpclient.myClass = BA.getDeviceClass ("b4a.example.xhttpclient");
xhttprequest.myClass = BA.getDeviceClass ("b4a.example.xhttprequest");
xhttpresponse.myClass = BA.getDeviceClass ("b4a.example.xhttpresponse");
xhttpjob.myClass = BA.getDeviceClass ("b4a.example.xhttpjob");
callback.myClass = BA.getDeviceClass ("b4a.example.callback");
